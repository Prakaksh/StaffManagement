demo = {
    ...
    initFormExtendedDatetimepickers: function () {
        ...
        $('.datepickermindate').datetimepicker({
            format: 'DD/MM/YYYY',
            icons: {
                time: "fa fa-clock-o",
                date: "fa fa-calendar",
    ...
    initMaterialWizard: function () {
        ...
        $('.wizard-card').bootstrapWizard({
            ...
            onInit: function (tab, navigation, index) {
                ...
                $width = 100 / $total;
                var $wizard = navigation.closest('.wizard-card').last();
                ...
                $('.wizard-card .wizard-navigation').last().append($moving_div);
                refreshAnimation($wizard, index);
                $('.moving-tab').css('transition', 'transform 0s');
            },

            //Commented by Chaitanya 20161220
            ...
            onTabShow: function (tab, navigation, index) {
                ...
                setTimeout(function () {
                    $wizard.last().find('.moving-tab').text(button_text);
                }, 150);
        ...
        $("#wizard-picture").change(function () {
            ...
            if ($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
                NotificationHandler.FailureAlert("Invalid image format, kindly select from these formats only (" + fileExtension.join(', ') + ")");
            }
            else {
                readURL(this);
            }
        ...
        function refreshAnimation($wizard, index) {
            ...
            $wizard.last().find('.moving-tab').css('width', step_width);
            $wizard.last().find('.moving-tab').css({
